          ...
          {skillGroups.map((group, groupIndex) => {
            ...
            return (
              <motion.article
                ...
                variants={card}
                whileHover={{ y: -5 }}
                className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#0b1127]/95 via-[#080d20]/92 to-[#060a18]/95 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl transition-colors duration-300 hover:border-ion/35"
              >
